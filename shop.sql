...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2016 at 09:05 AM
...
(20, 'Sang', '', 'hbk_vjp_619@yahoo.com', 1207056873, 0, '', 'Thank.', '2016-02-01 09:29:57'),
(19, 'Ben', '', 'benvjp619@gmail.com', 909761059, 0, '', '', '2016-01-31 11:18:37');
...
(0, 4, 'HP 450', '<p><span style="background-color:rgb(255, 255, 255); color:rgb(68, 68, 68); font-family:myriadprosemibold,sans-serif; font-size:13px">Intel Core i5 3230M(4*2.60Ghz, 3MB Smart cache, 1600Mhz FSB), Intel 7 Series Express, 2GB DDR3 BUS 1600Mhz, 500 GB SATA, DVD-RW Double Layer, 14 LED HD (1366 x 768) 16:9 Gloss, Intel HD GPU Graphics 4000, Wireless 802.11 b/g/n, NIC 1 Gbps, Card Reader 5.1, Webcam 1.3M, Microphone, Bluetooth 4.0, HDMI, 2.1 Kg, Pin 6 Cell, DOS</span></p>\r\n', 'HP450.jpg', 10690000, 'new', 0, 0),
...
('', '', '', 0, 'sang', '83a046ffa06d5c37860bca369940cd73', 1, 1),
('', '', '', 0, 'ben', '7fe4771c008a22eb763df47d19e2c6aa', 1, 1);
...
--
ALTER TABLE `lienhe`
  MODIFY `id_lienhe` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `loaisanpham`
--
ALTER TABLE `loaisanpham`
  MODIFY `id_loai` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `nhomsanpham`
--
ALTER TABLE `nhomsanpham`
  MODIFY `id_nhom` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
